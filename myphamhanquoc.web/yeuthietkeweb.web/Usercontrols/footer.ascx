  ...
  <div class="topmenu_footer">
      ...
      <div class="ctentColuMenuFooter">
        ...
        <div class="rowlistMenuFooter">
          <asp:Repeater ID="rptBrand" runat="server">
            <ItemTemplate> <a href="/thuong-hieu.html?thuonghieu=<%#Eval("ID") %>"><%#Eval("NAME") %></a> </ItemTemplate>
          </asp:Repeater>
        </div>
      </div>
    </div>
          ...
          <div class="ctentColuMenuFooter">
            ...
            <div class="listMenuFooter">
              <asp:Repeater ID="Repeater1" runat="server" DataSource='<%# Load_Menu2(Eval("Cat_ID")) %>'>
                <ItemTemplate> <a href="<%#GetLink_Cat(Eval("Cat_Url"),Eval("Cat_Seo_Url")) %>"> <%#Eval("CAT_NAME") %></a> </ItemTemplate>
              </asp:Repeater>
            </div>
          </div>
        </div>
    ...
    <div class="three columns" id="visitors">
      <div class="ctentColuMenuFooter">
        ...
        <div class="listMenuFooter">
          <p> Tổng truy cập: <strong>
            <asp:Literal ID="lbTotal" runat="server"></asp:Literal>
            </strong></p>
          <p> Hôm nay: <strong>
            <asp:Literal ID="lbToday" runat="server"></asp:Literal>
            </strong></p>
          <p> Đang truy cập: <strong>
            <asp:Literal ID="lbOnline" runat="server"></asp:Literal>
            </strong></p>
        </div>
        <h3> <a href="javascript:void(0)">Kết nối</a></h3>
        <div class="listMenuFooter" id="social_network">
          <asp:Repeater ID="rptSocialNetwork" runat="server">
            <ItemTemplate> <%# Bind_SocialNetwork(Eval("ONLINE_TYPE"), Eval("ONLINE_DESC"), Eval("ONLINE_NICKNAME"))%> </ItemTemplate>
          </asp:Repeater>
        </div>
      </div>
    </div>
    <div class="five columns" id="get_email">
      <div class="ctentColuMenuFooter">
        ...
        <span class="mobileIphone"><a href="http://m.websitemypham.com/">Chuyển sang phiên bản Mobile</a></span> </div>
    </div>
  </div>
</footer>
<!--End Footer-->
