      ...
      <asp:Repeater ID="Rpmenu" runat="server">
        <ItemTemplate>
          <div class='slide_item hvr-rectangle-out' id='sl<%= getIdAuto() %>'> <a href="<%#GetLink_Cat(Eval("cat_url"),Eval("cat_seo_url"))%>" title="<%#Eval("cat_name")%>" class='img_slide'><img src="<%#GetImage_Cat(Eval("CAT_ID"),Eval("CAT_IMAGE2"))%>" /></a>
            <h3 class='hvr-underline-from-center'><a href="<%#GetLink_Cat(Eval("cat_url"),Eval("cat_seo_url"))%>" title="<%#Eval("cat_name")%>"><%#Eval("cat_name")%></a></h3>
          </div>
        </ItemTemplate>
      </asp:Repeater>
    </div>
...
<div class="main cf">
  ...
  <div class="box">
    <div id="tabs-container">
      <ul class="tabs_menu">
        <li rel="tab-1"><span>Sản phẩm bán chạy</span></li>
        <li rel="tab-2"><span>Sản phẩm khuyến mãi</span></li>
      </ul>
                ...
                <ItemTemplate>
                  <li>
                    <div class="product">
                      ...
                      <a href="<%# "../Pages/addtocart.aspx?id=" + Eval("NEWS_ID") %>" class="addtocart">Mua hàng</a> </div>
                  </li>
                </ItemTemplate>
              </asp:Repeater>
            </ul>
