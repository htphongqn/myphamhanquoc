                ...
                for (int i = s; i <= _sotrang; i++)
                {
                    ...
                    else
                    {
                        if (type == 2)
                        {
                            ...
                            {
                                _re += "<a href='/tim-kiem.html?page=" + (_page + 1) + "&keyword=" + _keyword + "&catid=" + _catid + "'> >> </a>";
                            }
                            else if (i == s && _page >= 7)
                            {
                                _re += "<a href='/tim-kiem.html?page=" + (_page - 1) + "&keyword=" + _keyword + "&catid=" + _catid + "'> >> </a>";
                                ...
                                _re += "<a href='/tim-kiem.html?page=" + i + "&keyword=" + _keyword + "&catid=" + _catid + "'>" + i + "</a>";
                        }
                        else if (type == 1)
                        {
                            ...
                            if (i == _sotrang && _page >= 7)
                            {
                                _re += "<a href='/" + cat_seo_url + ".html?page=" + (_page + 1) + getUrl + "'> >> </a>";
                            }
                            else if (i == s && _page >= 7)
                            {
                                _re += "<a href='/" + cat_seo_url + ".html?page=" + (_page - 1) + getUrl + "'> << </a>";
                                ...
                                _re += "<a href='/" + cat_seo_url + ".html?page=" + i + getUrl + "'>" + i + "</a>";
                        }
                        else if (type == 3)
                        {
                            if (i == _sotrang && _page >= 7)
                            {
                                _re += "<a href='/" + cat_seo_url + ".html?page=" + (_page + 1) + "&thuonghieu=" + _idbrand + "'> >> </a>";
                            }
                            else if (i == s && _page >= 7)
                            {
                                _re += "<a href='/" + cat_seo_url + ".html?page=" + (_page - 1) + "&thuonghieu=" + _idbrand + "'> << </a>";
                                ...
                                _re += "<a href='/" + cat_seo_url + ".html?page=" + i + "&thuonghieu=" + _idbrand + "'>" + i + "</a>";
                        }
