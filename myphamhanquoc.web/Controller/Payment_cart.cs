...
namespace Controller
{
    public class Payment_cart
    {
        ...
        //Inser order
        private int Insert_Order(int userId, decimal Total_All, string Name, string OrderCode, string Email, string Address, int PaymentID, Guid News_guid, string Desc, DateTime Date, string Phone)
        {
            int _orderID = -1;
        ...
        public int Payment_cart_rs(int userId, Guid _guid, decimal _totalmoney, string _sEmail, string _sName, string _sPhone, string _sAddress,int _iPaymentID,string hinhthuc, string _sDesc, string _nameweb, string _url_web)
        {
            try
            {
                int _orderID = Insert_Order(userId, _totalmoney, _sName, Getorder_code(), _sEmail, _sAddress, _iPaymentID, _guid, _sDesc, DateTime.Now, _sPhone);
