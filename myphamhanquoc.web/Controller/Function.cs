...
namespace Controller
{
    public class Function
    {
        ...
        public string getBuy(object NEWS_ID, object NEWS_FIELD3)
        {
            ...
            if (sta == 1)
                return "<div class='addtocart'><a href='../Pages/addtocart.aspx?id=" + NEWS_ID + "'>Mua ngay</a></div>";
            return "";
        }
        ...
        public string Getbanner(object Banner_type, object banner_field, object Banner_ID, object Banner_Image)
        {
            ...
            return banner == "1" ? "<span class='four columns' id='logo'><a href='/trang-chu.html'>" + GetImage(Banner_type, Banner_ID, Banner_Image) + "</a></span>" : "<figure class='brand-name'> " + GetImagebanner(Banner_type, Banner_ID, Banner_Image) + "</figure>";
        }
            ...
            try
            {
                ...
                if (Utils.CIntDef(Banner_type) == 0)
                {
                    if (Utils.CIntDef(Banner_ID) > 0 && !string.IsNullOrEmpty(Utils.CStrDef(Banner_Image)))
                        ...
                        return "<img src='/Pages/Images/Logo.png'/>";
                }
                else
                {
                    if (Utils.CIntDef(Banner_ID) > 0 && !string.IsNullOrEmpty(Utils.CStrDef(Banner_Image)))
        ...
        public string Bind_SocialNetwork(object Type, object Description, object Nickname)
        {
            try
            {
                ...
                {
                    case 3:
                        _sResult += "<a href='" + Utils.CStrDef(Nickname) + "' target='_blank' title='" + Utils.CStrDef(Description) + "' class='facebook'></a>";
                        break;
                    case 4:
                        _sResult += "<a href='" + Utils.CStrDef(Nickname) + "' target='_blank' title='" + Utils.CStrDef(Description) + "' class='google_plus'></a>";
                        break;
                    case 5:
                        _sResult += "<a href='" + Utils.CStrDef(Nickname) + "' target='_blank' title='" + Utils.CStrDef(Description) + "' class='twitter'></a>";
                        break;
                    case 6:
                        _sResult += "<a href='" + Utils.CStrDef(Nickname) + "' target='_blank' title='" + Utils.CStrDef(Description) + "' class='you_tube'></a>";
                        break;
                    default:
                        break;
                }
