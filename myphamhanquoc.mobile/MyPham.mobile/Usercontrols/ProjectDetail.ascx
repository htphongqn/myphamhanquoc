...
<uc1:Path ID="Path1" runat="server" />
    ...
    <div id="owl-slidebanner_dtp" class="owl-carousel">
        <asp:Repeater ID="Rpalbumimg" runat="server">
          <ItemTemplate>
            <div class="item"> 
                <%# GetImageT(Eval("NEWS_ID"),Eval("NEWS_IMG_IMAGE1")) %>
            </div>
          </ItemTemplate>
        </asp:Repeater>
    </div>
    ...
    <div class="box">
    <div id="dtp_info">
        <h1 class="h1Title"><asp:Label ID="LabelNEWS_TITLE" runat="server"></asp:Label></h1>
        ...
        <div class="dtp_status" id="code_P"> <span class="title_status">Mã sản phẩm:</span><b class="txtMSP"><asp:Label ID="lblCodeProduct" runat="server"></asp:Label></b> </div>
        ...
        <!--end: .dtp_status-->
        <div class="dtp_status" id="viewed_count"> <span class="title_status">Lượt xem: </span><b class="numberView"><asp:Label ID="lblView" runat="server"></asp:Label></b> </div>
        <div class="dtp_status"> <span class="title_status">Giá bán:</span><b><asp:Label ID="lblGiaKm" runat="server"></asp:Label></b></div>
        <!--end: .dtp_status-->
        <div class="dtp_status shortInfoPro"> <span id="ContentPlaceHolder1_ctl00_Lbdesc_details">Mô tả<br/>
           <asp:Literal ID="LiteralNEWS_DESC" runat="server"></asp:Literal></span> </div>
        <!--end: .dtp_status-->
        <div class="btn_addtocart"> 
            <asp:Repeater ID="Rpttintuc" runat="server">
            <ItemTemplate>
                <a href="<%# GetBuyButton(Eval("NEWS_ID"), Eval("NEWS_PRICE2"), Eval("NEWS_PRICE1"))%>" class="btn_web cart_btn"><span>Mua ngay</span></a>
            </ItemTemplate>
            </asp:Repeater>
    ...
    <div class="box">
    <div class="box_Tab">
        <div class="tt_tab"><span>B&Igrave;NH LUẬN</span></div>
    </div>
    </div>
    <div class="box" id="thesame_P" runat="server">
    <div class="box_Tab">
        <div class="tt_tab"> <span>Sản phẩm tương tự</span></div>
    </div>
    <div class="box_ct">
        <div id="owl-slideP" class="owl-carousel slide_products">
        <asp:Repeater ID="Rptinkhac" runat="server">
        <ItemTemplate>
        <div class="item_P">
            <div class="product">
            <div class="img_product">
                <a href="<%# GetLink(Eval("NEWS_URL"),Eval("NEWS_SEO_URL"),Eval("CAT_SEO_URL")) %>"><%# GetImageT(Eval("NEWS_ID"),Eval("NEWS_IMAGE3")) %></a> </div>
            <div class="info_P">
