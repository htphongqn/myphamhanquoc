<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpages/Default.Master" AutoEventWireup="true" CodeBehind="listBrands.aspx.cs" Inherits="MyPham.Pages.listBrands" %>
...
<div class="navigation_news" id="divmore">       
    <a onclick="viewmore(<%=getId() %>,<%=getCountList() %>,3);" href="javascript:void(0)" class="btn_web pagination-button" style="cursor:pointer;color:White">Xem thêm sản phẩm »</a>
</div>
