...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <!--Cart-->
  <div class="box">
    <h1 class="box_Tab">Giỏ hàng của bạn</h1>
    <div class="box_ct whiteBg">
      ...
      <div class="foo-cart">
        <div class="total-cart"> Tổng tiền:<span id="total-money"> <span id="ContentPlaceHolder1_Lbtotal">
          <asp:Label ID="Lbtotal" runat="server" ></asp:Label>
          </span> </span> </div>
      </div>
      <div class="button_cart" style="float:left;width:100%"> <a href="/thanh-toan.html" class="btn_web btn_payment">Tiến hành đặt hàng »</a> <a href="/" class="btn_web btn_payment">Mua thêm sản phẩm khác</a> </div>
    </div>
  </div>
  <!--End Cart-->
</asp:Content>
