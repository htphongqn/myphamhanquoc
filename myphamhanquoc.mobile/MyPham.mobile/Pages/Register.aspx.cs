        ...
        protected void Lbregis_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtcode.Value == this.Session["CaptchaImageText"].ToString())
            {
                if (acc.Register(_fullname, _email, _pass, _sphone, _add))
                {
                    ...
                    _sbody += "      <td align='left' valign='' width='100%'><h2 style='font-weight:bold;font-size:12px'>Thư xác nhận đăng ký tài khoản từ <a href='" + System.Configuration.ConfigurationManager.AppSettings["URLWebsite"] + "' target='_blank'>" + System.Configuration.ConfigurationManager.AppSettings["URLWebsite"] + "</a></h2></td>";
